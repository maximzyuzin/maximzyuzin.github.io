...
export interface ProductListShopСartProps {
  products: Product[];
}
...
export const ProductListShop: FC<ProductListShopСartProps> = ({ products }) => {
  ...
  return (
    <>
      ...
      <div>
        <Button size={"medium"} label={"Показать Ещё"} onClick={createProduct} />
      </div>
    </>
  );
};
